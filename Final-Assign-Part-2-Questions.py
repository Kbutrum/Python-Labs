...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
            exp_rec= recession_data.groupby(Advertising_Expenditure)['Vehicle_Type'].sum().reset_index()
            R_chart3 = dcc.Graph(
                    figure=px.pie(exp_rec.,
                    values='Advertising_Expenditure', 'Vehicle_Type',
                 names='Advertising_Expenditure', 'Vehicle_Type',
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        ...
        x='Automobile_Sales',
        y='unemployment_rate','Vehicle_Type',
